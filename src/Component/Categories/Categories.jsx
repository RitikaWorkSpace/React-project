    ...
    return (
        <div className='max-w-[1170px] w-[100%] mx-auto mt-[80px]'>
            <div>
                ...
                <h3 className='text-[#DB4444] font-poppins font-[600] text-[16px] ml-[16px] my-auto leading-[20px]'>Categories</h3>
                </div>
                <div className='flex flex-col md:flex-row  lg:flex-row justify-between'>
                <h1 className='font-inter text-black text-[36px] font-[600] leading-[48px] mt-[20px]'>Browse By Category</h1>
