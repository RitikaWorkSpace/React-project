  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 max-w-[1170px] w-[100%] mx-auto bg-black mt-[140px]">
      <div className="m-[37px]">
        <h6 className="text-[#00FF66] mb-[32px] ">Categories</h6>
        <h1 className="text-[600] text-[48px] text-white mb-[32px]">
          Enhance Your <br></br>Music Experience
        </h1>

        <CountdownBanner />

        <button className="bg-[#00FF66] text-white py-[16px] px-[48px] text-center mt-[40px] ">
          Buy Now!
        </button>
      </div>
