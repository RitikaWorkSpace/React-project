...
const AllCard = () => {
  ...
  return (
      ...
      <div className="flex mx-[10px]  mt-[80px]">
      ...
      <h1 className=" mx-[10px] font-intel font-[600] text-[36px]  my-[50px] ">
            All Products.
            </h1>
       ...
       {/*  product */}
       <div className=" flex flex-wrap justify-center items-center  gap-[30px] mb-[140px]">
        {product?.map((item, i) => (
