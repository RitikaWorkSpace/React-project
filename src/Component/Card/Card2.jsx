        ...
        <div className="max-w-[270px] w-full max-h-[350px] h-full " key={i}>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="relative w-[270px] h-[250px] bg-[#F5F5F5] group">
              <div className="absolute top-2 left-2 bg-[#44db47] text-white p-1 rounded-md">
                New
              </div>
              ...
              {/*add to card  */}
              <button
                className="text-center w-[100%] text-white bg-black p-[5px] absolute bottom-0 opacity-0 group-hover:!opacity-100 transition-opacity duration-300"
